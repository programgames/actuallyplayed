package fr.julien.playtimetracker.forge.client;

import fr.julien.playtimetracker.core.PlaytimeTracker;
import fr.julien.playtimetracker.forge.client.gui.GuiPlaytimeStats;
...
public final class PlaytimeKeyBindings {
    ...
    private static final String CATEGORY = "key.categories.playtimetracker";
    ...
    public PlaytimeKeyBindings(PlaytimeTracker tracker, Minecraft minecraft) {
        ...
        this.openStats = new KeyBinding("key.playtimetracker.open", Keyboard.KEY_NONE, CATEGORY);

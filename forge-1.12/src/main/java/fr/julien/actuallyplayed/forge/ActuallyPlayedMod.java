...
import fr.julien.actuallyplayed.forge.client.PlaytimeKeyBindings;
import fr.julien.actuallyplayed.forge.command.CommandPlayed;
import fr.julien.actuallyplayed.forge.config.ConfigChangeHandler;
import fr.julien.actuallyplayed.forge.config.ForgeConfig;
import fr.julien.actuallyplayed.forge.event.PlaytimeClientHandler;
import fr.julien.actuallyplayed.forge.event.StatsGuiHandler;
...
/**
 * Entry point of Actually Played.
 * <p>
...
@Mod(
        ...
        guiFactory = "fr.julien.actuallyplayed.forge.config.PlaytimeGuiFactory"
)
public final class ActuallyPlayedMod {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        ClientCommandHandler.instance.registerCommand(
                new CommandPlayed(tracker, Minecraft.getMinecraft()));
